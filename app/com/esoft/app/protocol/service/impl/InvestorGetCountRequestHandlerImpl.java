 ...
 *
 */
@Service("investorGetCountRequestHandler")
public class InvestorGetCountRequestHandlerImpl implements RequestHandler{
	...
	public Out handle(In in, Out out) {
		...
		try{
			...
			if(ipc==null){
				...
				out.setResultCode(ResponseMsgKey.SUCCESS);
				out.setResultMsg(ipc.getCount()+"");
				out.encryptResult(ipc.getCount()+"");
			}
