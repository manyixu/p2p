...
import com.esoft.yeepay.repay.service.impl.YeePayWeiXinAdvanceRepayOperation;
import com.esoft.yeepay.repay.service.impl.YeePayWeiXinNormalRepayOperation;
import com.esoft.yeepay.repay.service.impl.YeePayWeiXinOverdueRepayOperation;
import com.esoft.yeepay.trusteeship.exception.YeePayOperationException;

public class YeePayWeiXinRepayHome extends RepayHome {
	...
	@Resource
	YeePayWeiXinNormalRepayOperation yeePayWeiXinNormalRepayOperation;

	@Resource
	YeePayWeiXinAdvanceRepayOperation yeePayWeiXinAdvanceRepayOperation;
	
	@Resource
	YeePayWeiXinOverdueRepayOperation yeePayWeiXinOverdueRepayOperation;
	...
	public void normalRepay(String repayId) {
		...
		try {
			yeePayWeiXinNormalRepayOperation.createOperation(repay,
	...
	public void advanceRepay(String loanId) {
		...
		try {
			yeePayWeiXinAdvanceRepayOperation.createOperation(loan, FacesContext.getCurrentInstance());
		} catch (IOException e) {
	...
	public void overdueRepay(String repayId){
		...
		try {
			yeePayWeiXinOverdueRepayOperation.createOperation(repay,
					FacesContext.getCurrentInstance());
		} catch (IOException e) {
			e.printStackTrace();
		}catch (YeePayOperationException e) {
