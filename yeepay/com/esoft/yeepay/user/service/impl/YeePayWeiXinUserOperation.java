...
@Service("yeePayWeiXinUserOperation")
public class YeePayWeiXinUserOperation extends YeePayOperationServiceAbs<User> {
	@Resource
	...
	public TrusteeshipOperation createOperation(User user, FacesContext fc)
		...
		// 邮箱可以试试删除
		/*优化代码content.append("<email>" + user.getEmail() + "</email>");*/
		// 回调通知 URL
