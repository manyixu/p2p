 ...
 *
 */
@Service("yeePayUserMobileOperation")
public class YeePayUserMobileOperation extends YeePayOperationServiceAbs<User>{
	...
	public TrusteeshipOperation createOperation(User user,
		...
		to.setRequestUrl(YeePayConstants.RequestUrl.UPDATE_BOUND_MOBILE);
