...
public class TrusteeshipWeiXinHome {
	...
	@Resource
	YeePayUserMobileOperation yeePayUserMobileOperation;
	...
	public String updateMobile(){
		...
		FacesUtil.addInfoMessage("修改手机号成功");
	 ...
	 * 修改手机
	 */
	private void updateMobileS2S(){
		yeePayUserMobileOperation.receiveOperationS2SCallback(FacesUtil.getHttpServletRequest(),
				FacesUtil.getHttpServletResponse());
	}
