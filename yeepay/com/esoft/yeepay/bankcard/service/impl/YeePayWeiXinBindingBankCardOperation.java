...
@Service("yeePayWeiXinBindingBankCardOperation")
public class YeePayWeiXinBindingBankCardOperation extends YeePayOperationServiceAbs<BankCard> {
	...
	public void receiveOperationPostCallback(ServletRequest request)
		...
		if (flag) {
			...
			String requestNo = resultMap.get("requestNo").split(regix_requestNo)[0].replaceFirst(YeePayConstants.RequestNoPre.BINDING_YEEPAY_BANKCARD, "");
