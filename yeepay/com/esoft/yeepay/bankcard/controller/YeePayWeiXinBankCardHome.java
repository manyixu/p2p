...
import com.esoft.yeepay.bankcard.service.impl.YeePayWeiXinBindingBankCardOperation;
import com.esoft.yeepay.bankcard.service.impl.YeePayWeiXinUnbindingBankCardOperation;
import com.esoft.yeepay.sign.CFCASignUtil;
import com.esoft.yeepay.trusteeship.YeePayConstants;

public class YeePayWeiXinBankCardHome extends BankCardHome {

	@Resource
	private LoginUserInfo loginUserInfo;
	@Resource
	YeePayWeiXinBindingBankCardOperation yeePayWeiXinBindingBankCardOperation;
	@Resource
	YeePayWeiXinUnbindingBankCardOperation yeePayWeiXinUnbindingBankCardOperation;
	...
	public void bindingCardTrusteeship() {
		...
		PostMethod postMethod = new PostMethod(
				YeePayConstants.RequestUrl.MOBILE_BINDING_YEEPAY_BANKCARD);
		...
		try {
			yeePayWeiXinBindingBankCardOperation.createOperation(getInstance(),
	...
	public void unbindingCardTrusteeship() {
		...
		getInstance().setUser(loginUser);
		try {
			yeePayWeiXinUnbindingBankCardOperation.createOperation(getInstance(),
					FacesContext.getCurrentInstance());
		} catch (IOException e) {
