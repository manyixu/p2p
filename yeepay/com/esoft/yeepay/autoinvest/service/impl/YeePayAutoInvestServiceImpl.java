...
public class YeePayAutoInvestServiceImpl extends AutoInvestServiceImpl {
	...
	public void autoInvest(String loanId) {
		log.info("autoInvest::loanId = " + loanId);
		...
		log.info("autoInvest::isOpenAutoInvest = " + isOpenAutoInvest);
		if (!isOpenAutoInvest) {
			return;
		}
