...
public class ScheduleConstants {
	...
	public static class JobName {
		 ...
		 * 起息提醒
		 */
		public static final String START_INTEREST_ALERT = "start_interest_alert";
		
		/**
		 * 直接划款体验金到账 
		 */
		public static final String EXPERIENCEINVESTMENT = "experienceinvestment";
		
		/**
		 * 体验金
		 */
		public static final String EXPERIENCEGOLD = "experiencegold";
		/**
		 * 自动划扣
		 */
