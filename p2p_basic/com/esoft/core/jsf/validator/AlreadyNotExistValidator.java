...
//@Component
@FacesValidator(value = "com.esoft.core.validator.AlreadyNotExistValidator")
public class AlreadyNotExistValidator extends ValueChangeValidator implements
		PartialStateHolder {

	public static final String VALIDATOR_ID = "com.esoft.core.validator.AlreadyNotExistValidator";
	...
	//是否验证的不存在
	private boolean isValidateNotExist = true;
		...
		if (StringUtils.isNotEmpty(value)) {
			try {
				...
				if (StringUtils.isEmpty(entityClass)) {
					...
					expr=expr.replace("referrer", "mobileNumber");
	...
	public void restoreState(FacesContext context, Object state) {
		...
		if (state != null) {
			...
			/**caijinmin 从3改成2 201504161713 begin*/
			isValidateNotExist = (Boolean) values[2];
			/**caijinmin 从3改成2 201504161713 end*/
		}
	}
