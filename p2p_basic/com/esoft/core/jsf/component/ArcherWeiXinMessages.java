 ...
 */
@FacesComponent(ArcherWeiXinMessages.COMPONENT_TYPE)
@ResourceDependencies({
		// FIXME:缺少一个弹出层的class导入
		@ResourceDependency(library = "javax.faces", name = "jsf.js", target = "head"),
		@ResourceDependency(library = "primefaces", name = "jquery/jquery.js"),
		@ResourceDependency(library = "esoft", name = "style/archerMessage.css"),
		@ResourceDependency(library = "esoft", name = "js/archerWeiXinMessages.js", target = "head") })
public class ArcherWeiXinMessages extends OnloadScript {

	// Public constants
	// -----------------------------------------------------------------------------------------------

	/** The standard component type. */
	public static final String COMPONENT_TYPE = "com.esoft.core.component.ArcherWeiXinMessages";
