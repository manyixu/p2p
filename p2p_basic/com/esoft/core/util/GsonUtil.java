...
public class GsonUtil {
	...
	private static Gson gsonLCWU = null;
	private static JsonParser jsonParser = null;
	public static final GsonBuilder HibernatePBuilder = new GsonBuilder()
	...
	static {
		...
		gsonLCWU = new GsonBuilder().setFieldNamingPolicy(
	...
	public static <T> T fromJsonUnderScoreStyle(String json, Class<T> classOfT) {
		return gsonLCWU.fromJson(json, classOfT);
	}
