...
public class ConfigConstants {
	...
	public final static class Schedule {
		 ...
		 * 直接划款体验金到账  是否开启
		 */
		public static final String EXPERIENCEINVESTMENT = "schedule.experienceinvestment";
		
		/**
		 * 体验金 是否开启
		 */
		public static final String EXPERIENCEGOLD = "schedule.experiencegold";
		
		
		/**
		 * 起息提醒
		 */
		public static final String START_INTEREST_ALERT = "schedule.start_interest_alert";
		/**
		 * 自动划扣
		 */
		public static final String AUTOREPAYMENT = "schedule.autoRepayment";
		 ...
		 * 放款短信提醒Loan
		 */
		public static final String LOAN_MESSAGE_REMIND = "schedule.loan_message_remind";
		/**
		 * 体验金到期短信提醒
		 */
		public static final String EXPERIENCE_END = "schedule.experience_end";
		/**
		 * 体验金到期短信提醒
		 */
		public static final String EXPERIENCE_END_ALERT = "experience_end";
		//模版节点
		public static final String LOAN_MESSAGE_REMIND_ALERT = "loan_message_remind_alert";
		/**
		 * 还款短信提醒
		 */
		public static final String REPAYMENT_MESSAGE_REMIND = "schedule.repayment_message_remind";
		//模版节点
		public static final String REPAYMENT_MESSAGE_REMIND_ALERT = "repayment_message_remind_alert";
	...
	public final static class UserPointMonitor {
		 ...
		 * 投资送代金券(达到这个金额,则送代金券)
		 */
		public final static String SEND_COUPON_BY_INVEST = "user_coupon_moitor.invest";
	}
