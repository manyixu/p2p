...
public final class UserBillConstants {
	...
	public final static class OperatorInfo {
		...
		/**邀请返利成功*/
		public final static String REFERRER_SUCCESS = "referrer_success";
		
		/**活动金转出金额*/	
		public final static String WITHDRAWALS_SUCCESS = "withdrawals_success";
		
		/**划扣款转入金额*/	
		public final static String HUAKOU_SUCCESS = "withdrawals_success";
