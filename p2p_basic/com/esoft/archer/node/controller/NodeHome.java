...
public class NodeHome extends EntityHome<Node> implements Serializable {
	...
	public String save() {
		...
		operationLog.setOperationName(node.getTitle());
		operationLog.setOperationId(node.getId());
		...
		operationLog.setOperationUser(loginUserId);
		Node r = getBaseService().get(Node.class,node.getId());
		if(r==null){
