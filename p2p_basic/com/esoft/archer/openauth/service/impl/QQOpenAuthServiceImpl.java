...
public class QQOpenAuthServiceImpl extends OpenAuthServiceAbstract {
	...
	public String getQQNickname(String url) {
		String reps = HttpClientUtil.getResponseBodyAsString(url);
		JsonObject jt = GsonUtil.stringToJsonObject(reps);
		if (jt != null&&jt.get(OpenAuthConstants.QQ_NICKNAME)!=null) {
			return (String) jt.get(OpenAuthConstants.QQ_NICKNAME).getAsString();
		}
		return null;
	}
